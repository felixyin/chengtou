 ...
 */
package com.hzc.aams.modules.act.entity;

import java.util.Date;
import java.util.List;
import java.util.Map;

import com.hzc.aams.common.persistence.BaseEntity;
import com.hzc.aams.common.utils.TimeUtils;
import com.hzc.aams.modules.act.utils.Variable;
...
//	private String procExecUrl; 	// 流程执行（办理）RUL
	...
	private String flag; 		// 意见状态 1,表示审批通过;
