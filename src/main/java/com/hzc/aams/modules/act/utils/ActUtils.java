 ...
 */
package com.hzc.aams.modules.act.utils;
...
import com.hzc.aams.common.utils.ObjectUtils;
...
import com.hzc.aams.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
    ...
    public static final String[] PD_ESTIMATE_APPROVE = new String[]{"update_score_person_dept", "update_score_leader_boss"};
    public static final String[] PD_PROJECT_APPROVE = new String[]{"aprove_project_process"};
