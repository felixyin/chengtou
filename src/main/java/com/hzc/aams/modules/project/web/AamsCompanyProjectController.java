 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/project/company")
public class AamsCompanyProjectController extends BaseController {
    ...
    @RequiresPermissions({"project:company:view"})
...
//        搜索表单，设置默认下拉框选中
        if (StringUtils.isBlank(aamsProject.getType())) {
            aamsProject.setType(DictUtils.getDictValue("公司督办", "project_type", "2"));
        }
        ...
        return "modules/project/company/list";
    }
...
//        }
        ...
        return "modules/project/company/form";
    }
    ...
    public String view(AamsProject aamsProject, Model model) {
        ...
        return "modules/project/company/view";
    }

    @RequiresPermissions(value = {"project:company:save", "project:company:submit"}, logical = Logical.OR)
    ...
    public String save(AamsProject aamsProject, Model model, RedirectAttributes redirectAttributes) {
        ...
        return "redirect:" + Global.getAdminPath() + "/project/company/?repage";
    }

    @RequiresPermissions("project:company:delete")
    ...
    @RequiresPermissions("project:company:order")
