...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			<label class="control-label">评分比率:</label>
			<div class="controls">
				<form:input path="remarks" type="number" htmlEscape="false" rows="3" maxlength="200" class="input-xlarge"/>
				<span class="help-inline">不同角色设置不同的评分比率，比如管理角色（部门长、分管领导、单位负责人）的评分比率比较高，例如：1.1，1.2，。13</span>
			</div>
		</div>
