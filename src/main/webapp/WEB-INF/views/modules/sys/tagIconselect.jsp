...
<div id="icons2">
    ...
    <ul class="the-icons">
        ...
        <li>
            <i class="icon iconfont icon-cf-c100"></i>
            <div class="name">通过</div>
            <div class="fontclass">.icon-cf-c100</div>
        </li>
        ...
        <li>
            <i class="icon iconfont icon-dvt-employee"></i>
            <div class="name">员工</div>
            <div class="fontclass">.icon-dvt-employee</div>
        </li>

        <li>
            <i class="icon iconfont icon-moxing"></i>
            <div class="name">模型</div>
            <div class="fontclass">.icon-moxing</div>
        </li>

        <li>
            <i class="icon iconfont icon-dvt-reject"></i>
            <div class="name">驳回</div>
            <div class="fontclass">.icon-dvt-reject</div>
        </li>
        ...
        <li>
            <i class="icon iconfont icon-jituanban"></i>
            <div class="name">集团版</div>
            <div class="fontclass">.icon-jituanban</div>
        </li>

        <li>
            <i class="icon iconfont icon-kaoqin1"></i>
            <div class="name">考勤</div>
            <div class="fontclass">.icon-kaoqin1</div>
        </li>

        <li>
            <i class="icon iconfont icon-average"></i>
            <div class="name">后评估平均分统计</div>
            <div class="fontclass">.icon-average</div>
        </li>
        ...
        <li>
            <i class="icon iconfont icon-daibananjian"></i>
            <div class="name">代办案件</div>
            <div class="fontclass">.icon-daibananjian</div>
        </li>
