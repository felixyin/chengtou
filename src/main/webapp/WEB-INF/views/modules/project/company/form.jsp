...
<ul class="nav nav-tabs my-nav-tabs">
    <li><a href="${ctx}/project/company/">公司督办项目列表</a></li>
    <li class="active"><a href="${ctx}/project/company/form?id=${aamsProject.id}">公司督办项目<shiro:hasPermission
            name="project:company:edit">${not empty aamsProject.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="project:company:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<div class="my-container">
    <form:form id="inputForm" modelAttribute="aamsProject" action="${ctx}/project/company/save" method="post"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <shiro:hasPermission name="project:company:type">
                ...
                <shiro:lacksPermission name="project:company:type">
                    ${fns:getDictLabel("type","project_type","公司督办" )}
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <shiro:hasPermission name="project:company:status">
                ...
                <shiro:lacksPermission name="project:company:status">
        ...
        <script type="text/template" id="aamsEstimateTpl">//<!--
            <tr id="aamsEstimateListDel{{parentIdx}}{{idx}}">
                ...
                <shiro:hasPermission name="project:company:estimate"><td class="text-center" width="10">
            ...
            <div class="controls">
                <table id="contentTable1" class="table table-striped table-bordered table-condensed"
                    ...
                    <tr>
                        ...
                        <th>项目负责人</th>
                        <th>备注信息</th>
                        <shiro:hasPermission name="project:company:user">
                            <th width="10">&nbsp;</th>
                        </shiro:hasPermission>
                    </tr>
                    </thead>
                ...
                <script type="text/template" id="aamsProjectUserTpl">//<!--
                            <tr id="aamsProjectUserList{{idx}}"  class="my-parent-tr">
                                ...
                                <shiro:hasPermission name="project:company:user"><td class="text-center" width="10">
                            ...
                            <tr><td colspan="3">
                                <table id="contentTable{{idx}}" class="table table-striped table-bordered table-condensed" style="width: 90%;">
                                    ...
                                    <tr>
                                        ...
                                        <th>进展情况</th>
                                        <th>备注信息</th>
                                        <shiro:hasPermission name="project:company:estimate">
                                        <th width="10">&nbsp;</th>
                                        </shiro:hasPermission>
                                    </tr>
                                    </thead>
        ...
        <div class="form-actions my-form-actions">
            ...
            <%--<c:if test="${aamsProject.status == 1 || aamsProject.status == 2 || aamsProject.status == 5}"> &lt;%&ndash; 3：进行中；4：结项，不能修改，其余情况可以修改 &ndash;%&gt;--%>
                <shiro:hasPermission name="project:company:save">
            ...
            <c:if test="${status == 2 || aamsProject.status == 1 || aamsProject.status == 5}"> <%--1:未提交状态--%>
                <shiro:hasPermission name="project:company:submit">
            ...
            <shiro:hasPermission name="project:company:delete">
                <a class="btn btn-danger" href="${ctx}/project/company/delete?id=${aamsProject.id}"
                   onclick="return confirmx('确认要删除这个公司督办项目吗？', this.href)">删除</a>
            </shiro:hasPermission>
