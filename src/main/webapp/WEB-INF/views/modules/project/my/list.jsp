...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('.my-tip').popover({});
            <shiro:hasPermission name="project:my:order">
            $("#dndTable").tableDnD({
...
<ul class="nav nav-tabs my-nav-tabs">
    <li class="active"><a href="${ctx}/project/my/">个人督办项目列表</a></li>
    <shiro:hasPermission name="project:my:add">
        <li><a href="${ctx}/project/my/form">个人督办项目添加</a></li>
    </shiro:hasPermission>
    <li><a href="javascript:$('#searchForm').toggle()"><i class="icon-search"></i></a></li>
</ul>
<div class="my-list-container">
    <form:form id="searchForm" modelAttribute="aamsProject" action="${ctx}/project/my/" method="post"
    ...
    <table id="contentTable" class="table table-striped table-bordered table-condensed default-table-tr-border">
        ...
        <tr>
            ...
            <shiro:hasPermission name="project:my:edit">
                <th>操作</th>
            </shiro:hasPermission>
        </tr>
        </thead>
        ...
        <c:forEach items="${page.list}" var="aamsProject" varStatus="status">
            <tr>
                ...
                <td>
                    <a href="javascript:showDialogByUrl('${ctx}/project/my/view?id=${aamsProject.id}','查看详情，项目编号：${aamsProject.num}');"
                       >
                            ${aamsProject.num}
                    </a>
                </td>
                ...
                <shiro:hasPermission name="project:my:edit">
                    <td>
                        <a href="${ctx}/project/my/form?id=${aamsProject.id}">修改</a>
                    </td>
                </shiro:hasPermission>
            </tr>
        </c:forEach>
