...
<ul class="nav nav-tabs my-nav-tabs">
    <li><a href="${ctx}/project/my/">个人督办项目列表</a></li>
    <li class="active"><a href="${ctx}/project/my/form?id=${aamsProject.id}">个人督办项目<shiro:hasPermission
            name="project:my:edit">${not empty aamsProject.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
            name="project:my:edit">查看</shiro:lacksPermission></a></li>
</ul>
<br/>
<div class="my-container">
    <form:form id="inputForm" modelAttribute="aamsProject" action="${ctx}/project/my/save" method="post"
        ...
        <div class="control-group hide">
            ...
            <div class="controls">
                <shiro:hasPermission name="project:my:type">
                ...
                <shiro:lacksPermission name="project:my:type">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <shiro:hasPermission name="project:my:status">
                ...
                <shiro:lacksPermission name="project:my:status">
                    <c:set var="status" scope="request" target="aamsProject" property="status" value="2"></c:set>
                    ${fns:getDictLabel("status","project_types","待审批" )}
        ...
        <script type="text/template" id="aamsEstimateTpl">//<!--
            <tr id="aamsEstimateListDel{{parentIdx}}{{idx}}">
                ...
                <shiro:hasPermission name="project:my:estimate"><td class="text-center" width="10">
            ...
            <div class="controls">
                <table id="contentTable1" class="table table-striped table-bordered table-condensed"
                    ...
                    <tr>
                        ...
                        <th>项目负责人</th>
                        <th>备注信息</th>
                        <shiro:hasPermission name="project:my:user">
                            <th width="10">&nbsp;</th>
                        </shiro:hasPermission>
                    </tr>
                    </thead>
                ...
                <script type="text/template" id="aamsProjectUserTpl">//<!--
                            <tr id="aamsProjectUserList{{idx}}"  class="my-parent-tr">
                                ...
                                <shiro:hasPermission name="project:my:user"><td class="text-center" width="10">
                            ...
                            <tr><td colspan="3">
                                <table id="contentTable{{idx}}" class="table table-striped table-bordered table-condensed" style="width: 90%;">
                                    ...
                                    <tr>
                                        ...
                                        <th>进展情况</th>
                                        <th>备注信息</th>
                                        <shiro:hasPermission name="project:my:estimate">
                                        <th width="10">&nbsp;</th>
                                        </shiro:hasPermission>
                                    </tr>
                                    </thead>
        ...
        <div class="form-actions my-form-actions">
            <script type="text/javascript">
                ...
                <%--<c:if test="${status == 1 || aamsProject.status == 1 || aamsProject.status == 2 || aamsProject.status == 5}"> &lt;%&ndash; 3：进行中；4：结项，不能修改，其余情况可以修改 &ndash;%&gt;--%>
            <shiro:hasPermission name="project:my:save">
            ...
            <c:if test="${status == 2 || aamsProject.status == 1 || aamsProject.status == 5}"> <%--1:未提交状态--%>
                <c:if test="${isCurrentUser}"> <%--只有项目负责人对应账可以提交审核--%>
                    <shiro:hasPermission name="project:my:submit">
            ...
            <c:if test="${aamsProject.status == 1 || aamsProject.status == 5}"> <%-- 1：待提交，2：驳回，可以删除，其他状态，个人项目不可以删除 --%>
                <c:if test="${isCurrentUser}"> <%--只有项目负责人对应账可以删除--%>
                    <shiro:hasPermission name="project:my:delete">
                        <a class="btn btn-danger" href="${ctx}/project/my/delete?id=${aamsProject.id}"
                           onclick="return confirmx('确认要删除这个个人督办项目吗？', this.href)">删除</a>
                    </shiro:hasPermission>
                </c:if>
            </c:if>
