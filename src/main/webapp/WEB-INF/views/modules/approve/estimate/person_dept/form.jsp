...
<div class="my-container">
    <form:form id="inputForm" modelAttribute="oaEstimateApprove" action="${ctx}/approve/estimate/oaEstimateApprove/save" method="post" class="form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <sys:treeselect id="bumenUserId" name="bumenUserId"  value="${oaEstimateApprove.user.id}" labelName="user.name" labelValue="${oaEstimateApprove.user.name}"
        ...
        <div class="control-group">
            <label class="control-label">部门长操作时间：</label>
            <div class="controls">
                <input name="bumenTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
                       value="<fmt:formatDate value="${oaEstimateApprove.bumenTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
